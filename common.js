...
// we cannot use multiple onLoad events on the same page. as we needed to bind 2 events
//(1. from policeApi.js file 2. from the scroll.js file we used the below code to register the onload event)
